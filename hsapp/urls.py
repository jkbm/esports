...
urlpatterns = [
    ...
    url(r'^api/tournament/(?P<name>\w+)/$', views.TournamentReadUpdateDeleteView.as_view(), name='tournament_rest_api'),
    url(r'^api/match/$', views.MatchCreateReadView.as_view(), name='match_rest_api'),
    url(r'^api/match/(?P<name>\w+)/$', views.MatchReadUpdateDeleteView.as_view(), name='match_rest_api'),
